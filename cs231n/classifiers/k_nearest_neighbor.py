...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    dot_product = np.dot(X, self.X_train.T) # num_test x num_train
    dists = np.sqrt(-2 * dot_product + np.transpose([test_sum]) + train_sum 
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
    return dists
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      closest_y = [self.y_train[j] for j in closest_index]
      #########################################################################
      # TODO:                                                                 #
